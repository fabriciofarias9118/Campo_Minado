...
class TelaPrincipal : JFrame(){
    private val tabuleiro = Tabuleiro(qtdeLinhas = 16, qtdeColunas = 30, qtdeMinas = 1)
    private val painelTabuleiro = PinelTabuleiro(tabuleiro)
    ...
    private fun mostrarResultado(evento: TabuleiroEvento){
        SwingUtilities.invokeLater{
            val msg = when(evento){
                ...
                TabuleiroEvento.DERROTA -> "Voce perdeu... :p"
            }
